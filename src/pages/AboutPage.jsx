...
const journeyPhotos = [
  { image: portrait,     alt: 'Tommera, coach and founder of Fitt With T' },
    ...
    <main className="about-page" ref={rootRef}>
      ...
      <section className="journey reveal">
        <div className="journey-wrap">
          <DepthCarousel
            items={journeyPhotos}
            cardWidth={isMobile ? 300 : 540}
            cardHeight={isMobile ? 400 : 680}
            depth={isMobile ? 140 : 220}
            spread={isMobile ? 50 : 90}
            tilt={22}
            tiltDirection="right"
            perspective={1400}
            visibleCards={4}
